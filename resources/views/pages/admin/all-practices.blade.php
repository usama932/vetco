                    ...
                    <div class="col-md-8 col-lg-7  ml-auto mr-auto pl-5 pr-5">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th colspan="2">
                                        <h3 class="mb-0 pb-0">The Vetco</h3>
                                    </th>
                                    <td class="text-right">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            onclick="showmodal('1252,lorem lorem lorem lorem lorem 1252,lorem lorem lorem')">
                            ...
                            <td> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="pb-0 mb-0"><span class=" ">Sudnay</span><span
                                                class="float-right pr-3">Closed</span></p>
                                        <p class="pb-0 mb-0"><span class="">Monday</span><span
                                                class="float-right pr-3">Closed</span></p>
                                        <p class="pb-0 mb-0"><span class="">Tuesday</span><span
                                                class="float-right pr-3">Closed</span></p>
                                        <p class="pb-0 mb-0"><span class="">Wednesday</span><span
                                                class="float-right pr-3">8:00 AM to 4:00 PM</span></p>
                                        <p class="pb-0 mb-0"><span class="">Thursday</span><span
                                                class="float-right pr-3">8:00 AM to 4:00 PM</span></p>
                                        <p class="pb-0 mb-0"><span class="">Friday</span><span
                                                class="float-right pr-3">Closed</span></p>
                                        <p class="pb-0 mb-0"><span class="">Saturday</span><span
                                                class="float-right pr-3">Closed</span></p>
                            ...
                            <table class="table table-hover text-blue">
                                <tbody>
                                    <tr class="">
                                        <th>Dental Cleaning</th>
                                        <th>
                                            <input type="text" name="" id="" value="200" class="form-control" readonly
                                                disabled>
                                        </th>
                                    </tr>
                                    <tr class="">
                        ...
                        <div class="col-12">
                            <table class="table text-blue">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="" id="" class="form-control" value="lorem" readonly
                                                disabled>
                                        </td>
                                        <td>
                                            <input type="text" name="" id="" class="form-control" value="Ipsum" readonly
                                                disabled>
                                        </td>
                                        <td>
                                            <input type="text" name="" id="" class="form-control"
                                                value="lorem@lorem.com" readonly disabled>
                                        </td>
                                        <td>
                                            <input type="text" name="" id="" class="form-control"
                                                value="lorem ipsum dolar" readonly disabled>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 text-right">
                        <button class="btn btn-primary"
                            style="background-color: #2f6bcf;border-color: #2f6bcf;">Apply</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"
                        style="background-color: #2f6bcf;border-color: #2f6bcf;">Save changes</button>
                </div>
            </div>
        </div>
    </div>
