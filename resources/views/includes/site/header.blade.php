...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top pt-3 pb-3">
    <div class="container-fluid">
        ...
        {{--            <span class="navbar-toggler-icon icon-bar"></span>--}}
        {{--        </button>--}}
        <a href="javascript:;" id="mob-dropdown" class="desk-md-hide">
            <i class="fa fa-bars" aria-hidden="true"></i>
        </a>
        <div
            class="dropdown-menu mob-dropdown-menu dropdown-menu-right bg-primary text-white logout_dropdown ml-auto"
...
{{--                    @endif--}}
                    <li class="nav-item">
                        <a class="nav-link header_link text-primary" href="{{route('vet.register')}}">
                            Claim Practice
                        </a>
                    </li>
                    {{--                    <li class="nav-item">--}}
