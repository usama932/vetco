...
<div class="container">
  <div class="container">
    <div class="row pl-md-5 pr-md-5 justify-content-center">
        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a onclick="showmodal('1252,lorem lorem lorem lorem lorem 1252,lorem lorem lorem')"> <i
                    class="fa  fa-pen"></i></a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <p class="pb-0 mb-0"><span class=" ">Sunday</span><span class="float-right pr-3">Closed</span></p>
                ...
                <p class="pb-0 mb-0"><span class="">Wednesday</span><span class="float-right pr-3">8:00 AM to 4:00
                    PM</span></p>
                <p class="pb-0 mb-0"><span class="">Thursday</span><span class="float-right pr-3">8:00 AM to 4:00
                    PM</span></p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" style="background-color: #2f6bcf;border-color: #2f6bcf;">Save
          changes</button>
      </div>
    </div>
  </div>
